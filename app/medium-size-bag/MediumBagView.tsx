...
import { formatPerBag, type ProductProfile } from '@/lib/products';
...
// The product arrives with its live, admin-set price from the server page.
const MediumBagView = ({ product }: { product: ProductProfile }) => {
          ...
          <section className="space-y-5 sm:space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-[15px] text-[#555]">
                ...
                <span> · {formatPerBag(product.price, product.bagCount)}</span>
              </p>
